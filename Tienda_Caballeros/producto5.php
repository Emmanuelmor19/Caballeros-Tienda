...
<head>
    ...
    <title>Caballeros - Producto</title>
</head>
...
<body>
    ...
    <main class="Contenido">
        <?php
        $sql = new PDO('mysql:host=localhost;dbname=tienda_caballeros','root','');
        foreach($sql->query('SELECT * FROM producto WHERE id=5') as $product)
        ?>
        <h1><?php echo $product['articulo']?></h1>
        <div class="camisa">
